...
const Browse = () => {
  const propertyData = {
    ...
    description:
      "7 guests · 3 bedrooms · 4 beds · 1 bath",
      ...
      <div className="listing-page">
        ...
        <section className="details-section">
          ...
          <div className="details-content">
            <h1 className="title">{propertyData.title}</h1>
            <p className="location">{propertyData.location}</p>
            <p>{propertyData.description}</p>

            <div className="guest-highlight">
              <h4>{propertyData.guestHighlight}</h4>
              <p>{propertyData.guestDetail}</p>
            </div>

            <div className="reviews">
              <span>⭐ {propertyData.rating} · {propertyData.reviews} Reviews</span>
            </div>

            <div className="host-highlights">
              <div className="host-info">
                <img src="host-profile.jpg" alt="Host profile" />
                <p>Hosted by Shiyu</p>
              ...
              <div className="highlights">
                ...
                <div className="highlight-item">
                  ...
                  <div>
                    <p>1-min walk to the lake</p>
                    <p>This home is by Little Lake.</p>
                  </div>
                </div>
                <div className="highlight-item">
              ...
              <div className="description">
                <p>
                  ❤️ A unique, lovely elf house in front of the little lake. Here you’ll find a unique hideaway in the middle of Barrie with gorgeous lake views as far as the eye can see.
                </p>
