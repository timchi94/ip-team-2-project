					...
					<div className="details-content">
						...
						<div className="host-highlights">
							...
							<div className="description">
								<p>
									❤️ A unique, lovely elf house in front of the little lake.
									Here you’ll find a unique hideaway in the middle of Barrie
									with gorgeous lake views as far as the eye can see.
								</p>
